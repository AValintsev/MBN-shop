...
namespace Nop.Services.Installation
{
	public partial class CodeFirstInstallationServiceMBN : IInstallationService
	{
		...
		protected virtual void InstallTopics()
		{
			...
			_localizedEntityService.SaveLocalizedValue(homePageTopic, c => c.Title, "Электроника - это будущее", languageRu.Id);
			_localizedEntityService.SaveLocalizedValue(homePageTopic, c => c.Body,
				"Наш интернет магазин познакомит Вас с деятельностью в инновационной сфере - добывание криптовалюты, а также и с другими инновационными технологиями.",
				languageRu.Id);

			_localizedEntityService.SaveLocalizedValue(homePageTopic, c => c.Title,
				"Електроніка - це майбутнє",
				languageUa.Id);
			_localizedEntityService.SaveLocalizedValue(homePageTopic,
				c => c.Body,
				"Наш інтернет магазин познайомить вас із діяльністю в інноваційній сфері добування криптовалюти, а також з іншими новітніми технологіями.",
				languageUa.Id);
