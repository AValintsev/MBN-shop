...
namespace Nop.Plugin.Widgets.NivoSliderLocalized.Data
{
	public class SliderObjectContext : DbContext, IDbContext
	{
		...
		public SliderObjectContext(string nameOrConnectionString) : base(nameOrConnectionString) { }

		protected override void OnModelCreating(DbModelBuilder modelBuilder)
		{
			modelBuilder.Configurations.Add(new SliderItemMap());
		...
		internal void Set(SliderItem item)
		{
		...
		{
			Database.ExecuteSqlCommand("DROP TABLE SliderItem");
