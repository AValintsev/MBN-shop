	...
	class Validator : AbstractValidator<QOrderModel>
	{
		public Validator(ILocalizationService localizationService)
		{
			RuleFor(x => x.CustomerName)
			   .NotEmpty()
			   .WithMessage(localizationService.GetResource("Plugins.Order.QuickOrder.CustomerName.Required"));
			...
			RuleFor(x => x.CustomerEmail)
				...
				.WithMessage(localizationService.GetResource("Plugins.Order.QuickOrder.CustomerEmail.ErrorMessage"));
			...
			.WithMessage(localizationService.GetResource("Plugins.Order.QuickOrder.CustomerPhone.ErrorMessage"));
		}
	}
}