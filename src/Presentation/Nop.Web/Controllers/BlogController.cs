...
namespace Nop.Web.Controllers
{
	...
	{
		string cacheKey = "HOME_PAGE_BLOGS";
		...
		public virtual ActionResult HomePageBlogs()
		{
			var model = _cacheManager.Get(cacheKey, () =>
			{
				var viewModel = new List<BlogPostModel>();
				var latestBlogs = _blogService.GetAllBlogPosts(
					storeId: _storeContext.CurrentStore.Id,
				...
				{
					var modelItem = new BlogPostModel();
					_blogModelFactory.PrepareBlogPostModel(modelItem, blog, false);
